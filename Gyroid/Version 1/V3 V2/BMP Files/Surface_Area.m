clc
srcFile=dir('H:\Google Drive\College Stuff\Studies\Thesis (Project)\Models\Gyroid\V3 V2\BMP Files\*.bmp');
percentageBlack=zeros(1,length(srcFile));
sum=0;
for i=1:length(srcFile)
    filename=strcat('H:\Google Drive\College Stuff\Studies\Thesis (Project)\Models\Gyroid\V3 V2\BMP Files\',srcFile(i).name);
    I=imread(filename);
